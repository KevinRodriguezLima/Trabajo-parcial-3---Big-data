...
export const AUDIENCES: AudienceSeed[] = [
  {
    id: "alta-intencion",
    name: "ALTA_INTENCION_COMPRA",
    label: "Alta intención de compra",
    weight: 0.19,
    priority: "ALTA",
    description:
      "Usuarios que concentran múltiples vistas de producto y adiciones al carrito en una ventana corta de sesión.",
    rules: [
      "≥ 3 eventos VIEW_PRODUCT en ventana deslizante de 10 minutos",
      "≥ 1 evento ADD_TO_CART en la misma sesión",
      "Sin evento PURCHASE registrado aún",
    ],
    top_events: ["VIEW_PRODUCT", "ADD_TO_CART", "SEARCH"],
  },
  {
    id: "frecuentes",
    ...
    weight: 0.145,
    priority: "MEDIA",
    description: "Usuarios con compras recurrentes en las últimas ventanas de ejecución.",
    rules: ["≥ 3 eventos PURCHASE acumulados", "Sesiones activas en ≥ 2 días distintos"],
    top_events: ["LOGIN", "PURCHASE", "PAGE_VIEW"],
  },
  {
    id: "premium",
    ...
    weight: 0.088,
    priority: "ALTA",
    description: "Compradores con ticket promedio superior al percentil 90 del escenario.",
    rules: ["Ticket promedio > S/ 1,200", "perfil_agente = CLIENTE_PREMIUM"],
    top_events: ["PURCHASE", "VIEW_PRODUCT"],
  },
  {
    id: "abandono-carrito",
    ...
    rules: ["ADD_TO_CART sin PURCHASE en 15 minutos", "Sin REMOVE_FROM_CART explícito"],
    top_events: ["ADD_TO_CART", "PAGE_VIEW", "REMOVE_FROM_CART"],
  },
  {
    id: "tecnologia",
    name: "INTERESADOS_TECNOLOGIA",
    label: "Interesados en tecnología",
    weight: 0.112,
    priority: "MEDIA",
    description: "Usuarios cuyo interés se concentra en categorías de cómputo, telefonía y gaming.",
    rules: ["≥ 70 % de vistas en categorías tecnológicas", "≥ 2 búsquedas con términos técnicos"],
    top_events: ["SEARCH", "VIEW_PRODUCT"],
  },
  {
    id: "riesgo-abandono",
    ...
    weight: 0.071,
    priority: "ALTA",
    description: "Clientes con caída sostenida de actividad frente a su línea base histórica.",
    rules: ["Descenso > 60 % de eventos vs. ventana anterior", "Sin compras en la ejecución actual"],
    top_events: ["LOGIN", "PAGE_VIEW"],
  },
  {
    id: "nocturnos",
    name: "COMPRADORES_NOCTURNOS",
    label: "Compradores nocturnos",
    weight: 0.083,
    priority: "MEDIA",
    description: "Actividad concentrada entre las 22:00 y 03:00 hora local.",
    rules: ["≥ 80 % de eventos entre 22:00 y 03:00", "perfil_agente = COMPRADOR_NOCTURNO"],
    top_events: ["VIEW_PRODUCT", "PURCHASE", "SOCIAL_POST"],
  },
  {
    id: "exploradores",
    name: "USUARIOS_EXPLORADORES",
    label: "Usuarios exploradores",
    weight: 0.076,
    priority: "BAJA",
    description: "Alta navegación y búsquedas, con muy baja tasa de conversión.",
    rules: ["≥ 10 eventos PAGE_VIEW por sesión", "Conversión de sesión < 1 %"],
    top_events: ["PAGE_VIEW", "SEARCH"],
  },
  {
    id: "indecisos",
    name: "CLIENTES_INDECISOS",
    label: "Clientes indecisos",
    weight: 0.059,
    priority: "MEDIA",
    description: "Alternan adiciones y retiros del carrito sin concretar la compra.",
    rules: ["≥ 2 pares ADD_TO_CART / REMOVE_FROM_CART", "Duración de sesión > 12 minutos"],
    top_events: ["ADD_TO_CART", "REMOVE_FROM_CART"],
  },
  {
    id: "estacionales",
    name: "CLIENTES_ESTACIONALES",
    label: "Clientes estacionales",
    weight: 0.042,
    priority: "BAJA",
    description: "Usuarios que solo aparecen durante campañas comerciales especiales.",
    rules: ["Actividad únicamente en escenarios distintos de BASE", "perfil_agente = CLIENTE_ESTACIONAL"],
    top_events: ["SEARCH", "VIEW_PRODUCT", "PURCHASE"],
  },
];
